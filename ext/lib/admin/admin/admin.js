...
import Sidebar from 'lib/admin/admin-sidebar/admin-sidebar'
import TopicsListView from '../admin-topics/view'
import TopicForm from '../admin-topics-form/view'
import TagsList from 'lib/admin/admin-tags/view'
import TagForm from 'lib/admin/admin-tags-form/view'
import AdminComments from 'lib/admin/admin-comments/component'
import ModerateTags from 'lib/admin/admin-tags-moderation/component'
import EditForum from 'lib/admin/admin-edit-forum/component'
import user from 'lib/user/user'
import { domRender } from 'lib/render/render'
import title from 'lib/title/title'
import topicStore from 'lib/stores/topic-store/topic-store'
import { loadCurrentForum } from 'lib/forum/forum'
import AdminPermissions from 'lib/admin/admin-permissions/admin-permissions'
import { findPrivateTopics,
         findTopic } from 'lib/middlewares/topic-middlewares/topic-middlewares'
import { findAllTags,
         findTag,
         clearTagStore } from 'lib/middlewares/tag-middlewares/tag-middlewares'
import { privileges } from 'lib/middlewares/forum-middlewares/forum-middlewares'
import template from 'lib/admin/admin/admin-container.jade'
import forgotEmail from '../../site/forgot-email/component'
...
if (config.usersWhitelist) {
  require('lib/admin/admin-whitelists/admin-whitelists')
  require('lib/admin/admin-whitelists-form/admin-whitelists-form')
}
...
page(urlBuilder.for('admin.forgotEmail'), (ctx) => {
  ctx.sidebar.set('forgotEmail')
  render(<forgotEmail forum={ctx.forum} />, document.querySelector('.admin-content'))
})
