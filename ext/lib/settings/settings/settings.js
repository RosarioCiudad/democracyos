...
import Password from 'lib/settings/settings-password/view'
import Profile from '../settings-profile/view'
import Notifications from 'lib/settings/settings-notifications/view'
import Forums from 'lib/settings/settings-forum/view'
...
const isValid = (ctx, next) => {
  ...
  if (config.multiForum && user.privileges && user.privileges.canManage) valid.push(urlBuilder.for('settings.user-badges'))
