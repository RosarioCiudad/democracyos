  ...
  <div className='modal-confirmation'>
    ...
    <div className='confirmation-wrapper'>
      ...
      <div className='social-sharing'>
        <a target='_blank' href={`whatsapp://send?text=${encodeURIComponent(`Ya voté en el Presupuesto Participativo 2020 de Rosario. Participá entrando a `)}${window.location.origin}/presupuesto`} data-action="share/whatsapp/share" rel='noopener noreferrer' className='wh'> </a>
        <SharerFacebook
          className='fb'
          params={{
